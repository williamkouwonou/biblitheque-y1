...
public class EmpruntResource {
    ...
    public Object emprunter(@PathVariable String isbn) throws ParseException {
        ...
        String s = "M ou Mm vient d'emprunter le livre : \n  Titre :"
    ...
    public Object emprunter(@PathVariable("isbn") String isbn, @PathVariable("login") String login) throws ParseException {
        log.debug("REST request to emprunter  Livre : {}", isbn);
        Optional<Livre> lv = livreRepository.findOneByIsbn(isbn);
...
/**
 * 
 * @param parameters parametres de recherche : date emprunt min et max , mot clé
...
/**
 * 
 * @param parameters parametres de recherche : date emprunt min et max , mot clé, page et size
